    ...
    *,
    ...
    results = compute_dgst_t_batch_from_captures(
        ...
        four_gate_spatial_cost_semantic_weight=float(
            cfg.get("spatial_cost_semantic_weight", 1.0)
        ),
        four_gate_spatial_cost_distance_weight=float(
            cfg.get("spatial_cost_distance_weight", 1.0)
        ),
        ...
        jffn_entropy_beta_by_layer=cfg.get("jffn_entropy_beta_by_layer"),
        jffn_max_increment_gib=float(cfg.get("jffn_max_increment_gib", 1.5)),
        jffn_chunk_size=cfg.get("jffn_chunk_size"),
        jffn_force_full_parallel=bool(cfg.get("jffn_force_full_parallel", False)),
        jffn_validate_linearity=bool(cfg.get("jffn_validate_linearity", False)),
