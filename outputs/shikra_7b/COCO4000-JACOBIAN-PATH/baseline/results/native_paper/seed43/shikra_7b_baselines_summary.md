...
- 原始结果：`/home/apulis-dev/userdata/CODEX/test-cocochair/gfchair/outputs/shikra_7b/COCO4000-JACOBIAN-PATH/baseline/results/native_paper/seed43/shikra_7b_baselines.json`。
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| SVAR | 0.8367 | 0.8731 | 0.9236 | 0.8976 | 0.8796 | 0.9612 | 0.6705 | 0.5366 | 0.5962 | 0.8796 | 0.6525 |
...
| MetaToken-GB | 0.8277 | 0.8585 | 0.9313 | 0.8934 | 0.8670 | 0.9554 | 0.6648 | 0.4700 | 0.5507 | 0.8670 | 0.6410 |

## Test 结果（固定阈值 0.5）

| 方法 | Accuracy | Real P | Real R | Real F1 | Real AUROC | Real AUPR | Hall P | Hall R | Hall F1 | Hall AUROC | Hall AUPR |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| SVAR | 0.8358 | 0.8713 | 0.9248 | 0.8972 | 0.8796 | 0.9612 | 0.6706 | 0.5286 | 0.5912 | 0.8796 | 0.6525 |
...
| MetaToken-GB | 0.8304 | 0.8638 | 0.9275 | 0.8945 | 0.8670 | 0.9554 | 0.6643 | 0.4953 | 0.5675 | 0.8670 | 0.6410 |

## Train 结果（train-F1 模式在此选择阈值）

| 方法 | Accuracy | Real P | Real R | Real F1 | Real AUROC | Real AUPR | Hall P | Hall R | Hall F1 | Hall AUROC | Hall AUPR |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| SVAR | 0.8442 | 0.8748 | 0.9296 | 0.9013 | 0.8952 | 0.9645 | 0.7113 | 0.5659 | 0.6303 | 0.8952 | 0.7126 |
...
- Test Real F1 最高的方法是 **SVAR**：0.8976。
