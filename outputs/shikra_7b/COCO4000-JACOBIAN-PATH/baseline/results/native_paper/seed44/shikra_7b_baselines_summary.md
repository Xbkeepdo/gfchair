...
- 原始结果：`/home/apulis-dev/userdata/CODEX/test-cocochair/gfchair/outputs/shikra_7b/COCO4000-JACOBIAN-PATH/baseline/results/native_paper/seed44/shikra_7b_baselines.json`。
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| SVAR | 0.8343 | 0.8727 | 0.9205 | 0.8960 | 0.8756 | 0.9596 | 0.6617 | 0.5366 | 0.5926 | 0.8756 | 0.6500 |
...
| MetaToken-GB | 0.8277 | 0.8585 | 0.9313 | 0.8934 | 0.8669 | 0.9553 | 0.6648 | 0.4700 | 0.5507 | 0.8669 | 0.6409 |

## Test 结果（固定阈值 0.5）

| 方法 | Accuracy | Real P | Real R | Real F1 | Real AUROC | Real AUPR | Hall P | Hall R | Hall F1 | Hall AUROC | Hall AUPR |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| SVAR | 0.8346 | 0.8730 | 0.9205 | 0.8962 | 0.8756 | 0.9596 | 0.6623 | 0.5379 | 0.5937 | 0.8756 | 0.6500 |
...
| MetaToken-GB | 0.8304 | 0.8638 | 0.9275 | 0.8945 | 0.8669 | 0.9553 | 0.6643 | 0.4953 | 0.5675 | 0.8669 | 0.6409 |

## Train 结果（train-F1 模式在此选择阈值）

| 方法 | Accuracy | Real P | Real R | Real F1 | Real AUROC | Real AUPR | Hall P | Hall R | Hall F1 | Hall AUROC | Hall AUPR |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| SVAR | 0.8450 | 0.8788 | 0.9251 | 0.9013 | 0.8914 | 0.9625 | 0.7049 | 0.5837 | 0.6386 | 0.8914 | 0.7145 |
...
- Test Real F1 最高的方法是 **SVAR**：0.8960。
