    ...
    def test_compact_feature_record_has_exact_profile(self) -> None:
        ...
        record = _build_cost_variant_feature_record(
            ...
            span={
                "word": "car",
                "label": 1,
                "target_locator_protocol": (
                    "inslen_official_first_token_first_occurrence"
                ),
                "official_detected_word": "car",
                "inslen_official_resolution": {
                    "candidate_surface": " car",
        ...
        self.assertEqual(len(record), 31)
        self.assertEqual(
            record["target_locator_protocol"],
            "inslen_official_first_token_first_occurrence",
        )
        self.assertEqual(record["official_candidate_surface"], " car")
